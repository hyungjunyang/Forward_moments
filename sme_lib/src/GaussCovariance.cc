...
GaussCovariance::GaussCovariance( double var, double cor1, double cor2, double cor3, double azimuth)
: Covariance (var, cor1, cor2, cor3, azimuth)
{
  cout << "GaussCovariance::GaussCovariance() " <<endl;
}

GaussCovariance::~GaussCovariance(){
}

double GaussCovariance::getCov(double x1, double y1, double z1, 
